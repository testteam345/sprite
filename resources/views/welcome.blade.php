...
<!-- 
        <div class="row nopadding">
            ...
            <div class="col-sm-6">
                <div class="banner-shortcode style-3 wide" style="background-image: url(img/background-10.jpg);">
                    <div class="valign-middle-cell">
                        <div class="valign-middle-content">
               ...
               <div class="swiper-wrapper">
                   <div class="swiper-slide">
                        <div class="container">
                            <div class="row vertical-aligned-columns">
                                <div class="col-sm-6 col-xs-b30 col-sm-b0">
                                    <img src="img/thumbnail-24.jpg" class="block-image rounded-image" alt="" />
                                </div>
                        ...
                        <div class="aligned-middle-image-shortcode hidden-xs hidden-sm" data-swiper-parallax-x="-600">
                            <img src="img/thumbnail-25.png" alt="" />
                        </div>
                   </div>
                   <div class="swiper-slide">
                        <div class="container">
               ...
               <div class="swiper-wrapper">
                   <div class="swiper-slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6 col-xs-b30 col-sm-b0">
                                    <div class="banner-shortcode style-3 rounded-image" style="background-image: url(img/thumbnail-28.jpg);">
                                        <div class="valign-middle-cell">
                                            <div class="valign-middle-content">
        ...
        <div class="slider-wrapper">
            ...
            <div class="swiper-container" data-parallax="1" data-auto-height="1">
               <div class="swiper-wrapper">
                   <div class="swiper-slide" style="background-image: url(img/background-4.jpg);">
                        <div class="container">
                            <div class="row">
                            ...
                            <div class="slider-product-preview align-left">
                                <div class="product-preview-shortcode light">
                                    ...
                                    <div class="sidebar valign-middle" data-swiper-parallax-x="-300">
                                        <div class="valign-middle-content">
                                            <div class="entry active"><img src="img/product-71.png" alt="" /></div>
                                            <div class="entry"><img src="img/product-72.png" alt="" /></div>
                                            <div class="entry"><img src="img/product-73.png" alt="" /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row nopadding">
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="img/product-74.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="img/product-75.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="product-label red">20% discount</div>
                            <div class="preview">
                                <img src="img/product-76.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="img/product-77.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="img/product-78.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="product-label green">Best Price</div>
                            <div class="preview">
                                <img src="img/product-82.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="img/product-83.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="img/product-84.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        <div class="product-shortcode style-7">
                            <div class="preview">
                                <img src="img/product-85.jpg" alt="" />
                                <div class="preview-buttons valign-middle">
                                    <div class="valign-middle-content">
                                        <a class="button size-1 style-2" href="#">
                                            <span class="button-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 col-xs-b15 col-md-b0">
                    <div class="banner-shortcode style-4 rounded-image text-center" style="background-image: url(img/background-5.jpg);">
                        <div class="valign-middle-cell">
                            <div class="valign-middle-content">
                ...
                <div class="col-md-4 col-xs-b15 col-md-b0">
                    <div class="banner-shortcode style-4 rounded-image text-center" style="background-image: url(img/background-6.jpg);">
                        <div class="valign-middle-cell">
                            <div class="valign-middle-content">
                ...
                <div class="col-md-4 col-xs-b15 col-md-b0">
                    <div class="banner-shortcode style-4 rounded-image text-center" style="background-image: url(img/background-7.jpg);">
                        <div class="valign-middle-cell">
                            <div class="valign-middle-content">
