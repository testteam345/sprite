                ...
                <div class="footer-bottom">
                    <div class="row">
                        <div class="col-lg-8 col-xs-text-center col-lg-text-left col-xs-b20 col-lg-b0">
                            <div class="copyright">&copy; 2015 All rights reserved. Development by <a
                                    href="http://themeforest.net/user/unionagency" target="_blank">UnionAgency</a></div>
                            <div class="follow">
                        ...
                        <div class="col-lg-4 col-xs-text-center col-lg-text-right">
                            <div class="footer-payment-icons">
                                <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-4.jpg"
                                        alt="" /></a>
                                <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-5.jpg"
                                        alt="" /></a>
                                <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-6.jpg"
                                        alt="" /></a>
                                <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-7.jpg"
                                        alt="" /></a>
                                <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-8.jpg"
                                        alt="" /></a>
                                <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-9.jpg"
                                        alt="" /></a>
                            </div>
                        </div>
                    </div>
