...
<body>
                                  ...
                                  <div class="cart-toggle hidden-xs hidden-sm">
                                      <div class="cart-overflow">
                                          <div class="cart-entry clearfix">
                                              <a class="cart-entry-thumbnail" href="#"><img src="{{ env('APP_ASSET') }}assets/img/product-1.png" alt="" /></a>
                                          ...
                                          <div class="cart-entry clearfix">
                                              <a class="cart-entry-thumbnail" href="#"><img src="{{ env('APP_ASSET') }}assets/img/product-2.png" alt="" /></a>
                                              <div class="cart-entry-description">
                                                  <table>
                                                      <tr>
                                                          <td>
                                          ...
                                          <div class="cart-entry clearfix">
                                              <a class="cart-entry-thumbnail" href="#"><img src="{{ env('APP_ASSET') }}assets/img/product-3.png" alt="" /></a>
                                              <div class="cart-entry-description">
                                                  <table>
                                                      <tr>
                                                          <td>
                  ...
                  <div class="content-margins">
                      <div class="row">
                          <div class="col-xs-3 col-sm-1">
                              <a id="logo" href="index1.html"><img src="{{ env('APP_ASSET') }}assets/img/logo-2.png" alt="" /></a>  
                          </div>
                                                                  ...
                                                                  <div class="preview-buttons">
                                                                      <div class="buttons-wrapper">
                                                                          <a class="button size-2 style-2" href="product.html">
                                                                              <span class="button-wrapper">
                                                                                  <span class="icon"><img src="{{ env('APP_ASSET') }}assets/img/icon-1.png" alt=""></span>
                                                                                  <span class="text">Learn More</span>
                                                                              </span>
                                                                          </a>
                                                                          <a class="button size-2 style-3" href="#">
                                                                              <span class="button-wrapper">
                                                                                  <span class="icon"><img src="{{ env('APP_ASSET') }}assets/img/icon-3.png" alt=""></span>
                                                                  ...
                                                                  <div class="preview">
                                                                      <div class="swiper-container" data-loop="1">
                                                                          ...
                                                                          <div class="swiper-wrapper">
                                                                              ...
                                                                              <div class="swiper-slide">
                                                                                  <img src="{{ env('APP_ASSET') }}assets/img/product-61.jpg" alt="" />
                                                                              </div>
                                                                          </div>
                                                                      </div> 
                                                                  </div>
                                                                  ...
                                                                  <div class="preview">
                                                                      <div class="swiper-container" data-loop="1">
                                                                          ...
                                                                          <div class="swiper-wrapper">
                                                                              ...
                                                                              <div class="swiper-slide">
                                                                                  <img src="{{ env('APP_ASSET') }}assets/img/product-59.jpg" alt="" />
                                                                              </div>
                                                                          </div>
                                                                      </div> 
                                                                  </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-6 col-md-3 col-xs-b30 col-sm-b0">
                              ...
                              <div class="footer-post-preview clearfix">
                                  <a class="image" href="#"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-1.jpg" alt="" /></a>
                                  <div class="description">
                              ...
                              <div class="footer-post-preview clearfix">
                                  <a class="image" href="#"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-2.jpg" alt="" /></a>
                                  <div class="description">
                                      <div class="date">apr 07 / 15</div>
                                      <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                                  </div>
                              ...
                              <div class="footer-post-preview clearfix">
                                  <a class="image" href="#"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-3.jpg" alt="" /></a>
                                  <div class="description">
                                      <div class="date">apr 07 / 15</div>
                                      <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                                  </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-4 col-xs-text-center col-lg-text-right">
                              <div class="footer-payment-icons">
                                  <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-4.jpg" alt="" /></a>
                                  <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-5.jpg" alt="" /></a>
                                  <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-6.jpg" alt="" /></a>
                                  <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-7.jpg" alt="" /></a>
                                  <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-8.jpg" alt="" /></a>
                                  <a class="entry"><img src="{{ env('APP_ASSET') }}assets/img/thumbnail-9.jpg" alt="" /></a>
                              </div>
                          </div>
                      </div>
                  </div>
                                  ...
                                  <div class="swiper-container swiper-control-bottom" data-breakpoints="1" data-xs-slides="3" data-sm-slides="3" data-md-slides="4" data-lt-slides="5" data-slides-per-view="5" data-center="1" data-click="1">
                                     ...
                                     <div class="swiper-wrapper">
                                         <div class="swiper-slide">
                                          ...
                                          <div class="swiper-slide">
                                              <div class="product-small-preview-entry">
                                                  <img src="{{ env('APP_ASSET') }}assets/img/product-preview-10_.jpg" alt="" />
                                              </div>
                                         </div>
                              ...
                              <div class="row m5 col-xs-b40">
                                  <div class="col-sm-6 col-xs-b10 col-sm-b0">
                                      <a class="button size-2 style-2 block" href="#">
                                          <span class="button-wrapper">
                                              <span class="icon"><img src="{{ env('APP_ASSET') }}assets/img/icon-2.png" alt=""></span>
                                              <span class="text">add to cart</span>
                                          </span>
                                      </a>
                                  </div>
    ...
    <script>
        ...
        function feed_error_re(str) {
            str = '<div class="alert alert-danger" role="alert">' + str + '</div>';
            $('#feed_back_info_re').show();
            $('#feed_back_info_re').html(str);
            setTimeout(() => {
                    $('#feed_back_info_re').fadeOut(1500);
                }, 1500)
                ('#feed_back_info_re').html('');
            $('#feed_back_info_re').hide();
            $('#feed_back_info_re').fadein(1500);
